<?= $this->extend('layout/template_parallax'); ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                <h3 class="wow bounceIn" data-wow-delay="0.9s">Jan 22 - 26 in Surabaya, INA</h3>
                <h1 class="wow fadeInUp" data-wow-delay="1.6s">Web Parallax</h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="wow fadeInUp col-md-6 col-sm-6" data-wow-delay="0.6s">
                <h3>Web parallax is a fully responsive one-page template.</h3>
            ...
            <div class="wow fadeInUp col-md-6 col-sm-6" data-wow-delay="0.9s">
                <img src="images/overview-img.webp" class="img-responsive" alt="Overview">
            </div>
            ...
            <div id="owl-speakers" class="owl-carousel">
                ...
                <div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
                    <div class="speakers-wrapper">
                        <img src="images/speakers-img1.webp" class="img-responsive" alt="speakers">
                ...
                <div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.6s">
                    <div class="speakers-wrapper">
                        <img src="images/speakers-img2.webp" class="img-responsive" alt="speakers">
                        <div class="speakers-thumb">
                            <h3>David Yoon</h3>
                ...
                <div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
                    <div class="speakers-wrapper">
                        <img src="images/speakers-img3.webp" class="img-responsive" alt="speakers">
                        <div class="speakers-thumb">
                            <h3>Je Mary Lee</h3>
                ...
                <div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.6s">
                    <div class="speakers-wrapper">
                        <img src="images/speakers-img4.webp" class="img-responsive" alt="speakers">
                        <div class="speakers-thumb">
                            <h3>Johnathan Doe</h3>
                            <h6>Frontend Dev</h6>
                        </div>
                ...
                <div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.6s">
                    <div class="speakers-wrapper">
                        <img src="images/speakers-img5.webp" class="img-responsive" alt="speakers">
                        <div class="speakers-thumb">
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="fday">
                        ...
                        <div class="col-md-2 col-sm-2">
                            <img src="images/program-img1.webp" class="img-responsive" alt="program">
                        </div>
                        ...
                        <!-- program speaker here -->
                        <div class="col-md-2 col-sm-2">
                            <img src="images/program-img2.webp" class="img-responsive" alt="program">
                        </div>
                        <div class="col-md-10 col-sm-10">
                            <h6>
                        ...
                        <!-- program speaker here -->
                        <div class="col-md-2 col-sm-2">
                            <img src="images/program-img3.webp" class="img-responsive" alt="program">
                        </div>
                        <div class="col-md-10 col-sm-10">
                            <h6>
                    ...
                    <div role="tabpanel" class="tab-pane" id="sday">
                        <!-- program speaker here -->
                        <div class="col-md-2 col-sm-2">
                            <img src="images/program-img4.webp" class="img-responsive" alt="program">
                        </div>
                        <div class="col-md-10 col-sm-10">
                            <h6>
                                <span><i class="fa fa-clock-o"></i> 11.00 AM</span>
                        ...
                        <!-- program speaker here -->
                        <div class="col-md-2 col-sm-2">
                            <img src="images/program-img5.webp" class="img-responsive" alt="program">
                        </div>
                        <div class="col-md-10 col-sm-10">
                            <h6>
                        ...
                        <!-- program speaker here -->
                        <div class="col-md-2 col-sm-2">
                            <img src="images/program-img6.webp" class="img-responsive" alt="program">
                        </div>
                        <div class="col-md-10 col-sm-10">
                            <h6>
                    ...
                    <div role="tabpanel" class="tab-pane" id="tday">
                        <!-- program speaker here -->
                        <div class="col-md-2 col-sm-2">
                            <img src="images/program-img7.webp" class="img-responsive" alt="program">
                        </div>
                        <div class="col-md-10 col-sm-10">
                            <h6>
                                <span><i class="fa fa-clock-o"></i> 03.00 PM</span>
                        ...
                        <!-- program speaker here -->
                        <div class="col-md-2 col-sm-2">
                            <img src="images/program-img8.webp" class="img-responsive" alt="program">
                        </div>
                        <div class="col-md-10 col-sm-10">
                            <h6>
                        ...
                        <!-- program speaker here -->
                        <div class="col-md-2 col-sm-2">
                            <img src="images/program-img9.webp" class="img-responsive" alt="program">
                        </div>
                        <div class="col-md-10 col-sm-10">
                            <h6>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="wow fadeInUp col-md-3 col-sm-6 col-xs-6" data-wow-delay="0.3s">
                <img src="images/sponsor-img1.webp" class="img-responsive" alt="sponsors">
            </div>

            <div class="wow fadeInUp col-md-3 col-sm-6 col-xs-6" data-wow-delay="0.6s">
                <img src="images/sponsor-img2.webp" class="img-responsive" alt="sponsors">
            </div>

            <div class="wow fadeInUp col-md-3 col-sm-6 col-xs-6" data-wow-delay="0.9s">
                <img src="images/sponsor-img3.webp" class="img-responsive" alt="sponsors">
            </div>

            <div class="wow fadeInUp col-md-3 col-sm-6 col-xs-6" data-wow-delay="1s">
                <img src="images/sponsor-img4.webp" class="img-responsive" alt="sponsors">
            </div>
